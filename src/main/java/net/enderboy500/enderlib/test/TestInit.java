...
import net.enderboy500.enderlib.item.*;
...
public class TestInit {
    ...
    public static final Item TEST_2 = RegistryHelper.registerItem("test_2", TestItem::new, new Item.Settings().component(EnderLibComponents.SWEEP_ATTACK_PARTICLE, new SweepAttackParticleComponent(ParticleTypes.ANGRY_VILLAGER)).component(EnderLibComponents.ATTACK_SOUND_EFFECT, new AttackSoundEffectComponent(SoundEvents.BLOCK_ANVIL_DESTROY)));
