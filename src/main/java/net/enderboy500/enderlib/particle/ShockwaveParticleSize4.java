...
public class ShockwaveParticleSize4 extends ExplosionLargeParticle {
    public ShockwaveParticleSize4(ClientWorld world, double x, double y, double z, double d, SpriteProvider spriteProvider) {
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            return new ShockwaveParticleSize4(clientWorld, d, e, f, g, this.spriteProvider);
        }
    }
}
