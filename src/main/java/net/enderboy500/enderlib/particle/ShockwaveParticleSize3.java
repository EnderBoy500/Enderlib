...
public class ShockwaveParticleSize3 extends ExplosionLargeParticle {
    public ShockwaveParticleSize3(ClientWorld world, double x, double y, double z, double d, SpriteProvider spriteProvider) {
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            return new ShockwaveParticleSize3(clientWorld, d, e, f, g, this.spriteProvider);
        }
    }
}
