...
public class ShockwaveParticleSize7 extends ExplosionLargeParticle {
    public ShockwaveParticleSize7(ClientWorld world, double x, double y, double z, double d, SpriteProvider spriteProvider) {
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            return new ShockwaveParticleSize7(clientWorld, d, e, f, g, this.spriteProvider);
        }
    }
}
