...
public class VillagerHelper {
    ...
    public static VillagerProfession registerProfession(String id, RegistryKey<PointOfInterestType> type,String translationKey, SoundEvent soundEvent) {
        return Registry.register(Registries.VILLAGER_PROFESSION, ELib.customId(id), new VillagerProfession(Text.translatable(translationKey), entry -> entry.matchesKey(type), entry -> entry.matchesKey(type),
    ...
    public static VillagerProfession registerProfession(String id, RegistryKey<PointOfInterestType> type,Text text, SoundEvent soundEvent) {
        return Registry.register(Registries.VILLAGER_PROFESSION, ELib.customId(id), new VillagerProfession(text, entry -> entry.matchesKey(type), entry -> entry.matchesKey(type),
                ImmutableSet.of(), ImmutableSet.of(), soundEvent));
    }

    public static VillagerProfession registerProfession(String id, RegistryKey<PointOfInterestType> type, SoundEvent soundEvent) {
        return Registry.register(Registries.VILLAGER_PROFESSION, ELib.customId(id), new VillagerProfession(Text.translatable("entity." + ELib.currentModId +".villager." + id), entry -> entry.matchesKey(type), entry -> entry.matchesKey(type),
                ImmutableSet.of(), ImmutableSet.of(), soundEvent));
    }
    ...
    public static RegistryKey<PointOfInterestType> registerPOIKey(String id) {
        return RegistryKey.of(RegistryKeys.POINT_OF_INTEREST_TYPE, ELib.customId(id));
    }
